...
public class BuyServiceTest {
    ...
    public void shouldThrowException_WhenBucketNotFound() {
        ...
        assertThrows(BucketNotFoundException.class, () -> buyService.purchaseGames(1L));
    ...
    public void shouldThrowException_WhenGameNotFound() {
        ...
        assertThrows(GameNotFoundException.class, () -> buyService.purchaseGames(1L));
        ;
    }
    ...
    public void shouldThrowException_WhenAccountNotFound() {
        ...
        assertThrows(AccountNotFoundException.class, () -> buyService.purchaseGames(1L));
    }
}
